...
{
    private const string DataRowClassPrefixName = "GameFramework.DR";
    ...
    public static void LoadDataTable(this DataTableComponent dataTableComponent, string dataTableName, string dataTableAssetName, object userData = null)
    {
        ...
        dataTable.ReadData(DataTablePathHelp.GetDataTableAsset(dataTableName), Constant.AssetPriority.DataTableAsset, userData);
    }
